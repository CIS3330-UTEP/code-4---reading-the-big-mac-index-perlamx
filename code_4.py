...
def get_the_cheapest_big_mac_price_by_year(year):
    ...
    return f"{cheapest_row['name']}({cheapest_row['iso_a3']}): ${cheapest_row['dollar_price']:.2f}"
...
def get_the_most_expensive_big_mac_price_by_year(year):
    ...
    return f"{expensive_row['name']}({expensive_row['iso_a3']}): ${expensive_row['dollar_price']:.2f}"
